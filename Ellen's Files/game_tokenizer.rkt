...
(define adventure-lexer
  (lexer
   ...
   ["create_start"     (token 'START     lexeme)]
   ...
   ; ── start structural keywords ────────────────────────────────────
   ["start_room"  (token 'START-ROOM  lexeme)]
   ["title"       (token 'START-TITLE lexeme)]
   ["intro"       (token 'START-INTRO lexeme)]))
